...
import { Mail, Lock, Eye, EyeOff, Loader2, ActivitySquare, UserCheck } from 'lucide-react';
import { getAuth, GoogleAuthProvider } from 'firebase/auth';
import { loginWithEmail, signInWithGoogle } from "../../../src/config/firebaseAuth";
import { app } from '../../../src/config/firebase'; // Import initialized app
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/authside.png')",
